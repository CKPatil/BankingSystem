...
class Banking_System
{
    ...
    {
        Console.Clear();
        Center("****   Banking System | About Us ****\n");
        Console.BackgroundColor = ConsoleColor.DarkBlue;
        DrawLine();
        Console.WriteLine("|{0}|", AlignText(0, ""));
        Console.WriteLine("|{0}|", AlignText(34, "  Banking System v1.2.0.8"));
        Console.WriteLine("|{0}|", AlignText(35, "Developed By Anusha Manchi S"));
        Console.WriteLine("|{0}|", AlignText(34, "Information Science & Engineering[VIIIth Sem]"));
        Console.WriteLine("|{0}|", AlignText(0, ""));
        DrawLine();
        Console.BackgroundColor = ConsoleColor.Black;
    }
